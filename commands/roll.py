...
async def roll_command(interaction: discord.Interaction, guess: int):
    ...
    if guess == roll_result:
        ...
        # Note: check_and_give_achievement function needs to be imported or made available
...
def setup(bot):
    ...
    async def roll_slash_command(interaction: discord.Interaction, guess: int):
        await roll_command(interaction, guess)